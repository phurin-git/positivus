...
export default function CaseStudies() {
    return (
        <div id={link.usecases.substring(1)} className="pt-[70px] mt-[70px]">
            <HeadingAndSubHeading HeadLabel="Case Studies" SubHeadLabel="Explore Real-Life Examples of Our Proven Digital Marketing Success through Our Case Studies" SubWidth="580px"/>
            {/*Case Study block*/}
